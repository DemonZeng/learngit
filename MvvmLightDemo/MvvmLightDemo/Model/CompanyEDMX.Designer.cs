...
namespace MvvmLightDemo.Model
{
    ...
    public partial class CompanyEntities : ObjectContext
    {
        ...
        /// No Metadata Documentation available.
        /// </summary>
        public ObjectSet<EmployeeInfo> EmployeeInfo
        {
            get
            {
                if ((_EmployeeInfo == null))
                {
                    _EmployeeInfo = base.CreateObjectSet<EmployeeInfo>("EmployeeInfo");
                }
                return _EmployeeInfo;
            }
        }
        private ObjectSet<EmployeeInfo> _EmployeeInfo;
        ...
        /// <summary>
        /// Deprecated Method for adding a new object to the EmployeeInfo EntitySet. Consider using the .Add method of the associated ObjectSet&lt;T&gt; property instead.
        /// </summary>
        public void AddToEmployeeInfo(EmployeeInfo employeeInfo)
        {
            base.AddObject("EmployeeInfo", employeeInfo);
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="MvvmTestModel", Name="EmployeeInfo")]
    [Serializable()]
